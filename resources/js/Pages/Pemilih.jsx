...
function Pemilih(props) {
    ...
    const handleDelete = (id) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                Inertia.delete(`/delete/pemilih/${id}`, {onSuccess:()=>{
                    Swal.fire(
                        'Terhapus!',
    ...
    return (
        <DashboardLayout authe={props.auth} errors={props.errors} current_menu={'pemilih'} selectedId={selectedId}>
            <div className="main-content">
                <div className="page-content">
                    <div className="container-fluid">
                        <PageTitle crumbs="Home/Data Pemilih" title="Data Calon pemilih" />
                       
                        <Card addData={true} title={'Table Data Calon Pemilih Tertarget'} downloadDta={true} data={data} uploadData={true}>
                        <LokasiFilter
                ...
                expandableRowsComponent={ExpandedComponent} columns={columns} data={
                                    selectedIdKec
                                        ? filteredData
                                        : isSearch
                                        ? filteredData
