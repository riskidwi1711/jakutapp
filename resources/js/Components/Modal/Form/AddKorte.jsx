...
function AddKorte(props) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        Inertia.post("/insert/korte", state, {
            forceFormData: true,
            onSuccess: () => {
                Swal.fire("Berhasil!", "Data berhasil di inputkan.", "success");
                document.getElementById("form-korte").reset();
                setState({
                    nama: null,
                    alamat: null,
                    kecamatan: null,
    ...
    return (
        <form onSubmit={handleSubmit} id="form-korte">
            <div className="mb-3">
