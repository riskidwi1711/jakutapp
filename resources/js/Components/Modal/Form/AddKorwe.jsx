...
function AddKorwe(props) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        Inertia.post("/insert/korwe", state, {
            forceFormData: true,
            onSuccess: () => {
                Swal.fire("Berhasil!", "Data berhasil di inputkan.", "success");
                document.getElementById("form-korwe").reset();
                setState({
                    nama: null,
                    alamat: null,
                    kecamatan: null,
    ...
    return (
        <form onSubmit={handleSubmit} id="form-korwe">
            <div className="mb-3">
