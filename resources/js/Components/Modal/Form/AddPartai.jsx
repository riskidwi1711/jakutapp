...
function AddPartai(props) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        Inertia.post("/insert/partai", state, {
            forceFormData: true,
            onSuccess: () => {
    ...
    return (
        <form onSubmit={handleSubmit}>
            <div className="mb-3">
                <label className="form-label">Nama Partai</label>
                <input
                    type="text"
            ...
            <div className="mb-3">
                <label className="form-label">Nama Lengkap Partai</label>
                <input
                    type="text"
                    className="form-control"
                    id="nama_lengkap"
